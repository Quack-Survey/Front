...
const FormCreatingSample = ({
  modeName,
}: IFormCreatingSampleProps): JSX.Element => {
  return (
    <div>
      {modeName === "initial" ? (
        <div>
          <div className="flex w-[360px] h-full border-l-[8px] border-n-gray">
...
export default FormCreatingSample;
