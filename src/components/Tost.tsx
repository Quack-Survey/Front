...
const Toast = ({ toastText, onClose, editMode }: IToastProps): JSX.Element => {
  ...
  return (
    <div
      className={
        visible
          ? "z-100 fixed bottom-[65px] left-[16px] flex h-[43px] min-w-[150px] max-w-[200px] items-center gap-n-sm overflow-hidden bg-n-white p-n-md text-n-md text-n-red shadow-n-md transition-all"
