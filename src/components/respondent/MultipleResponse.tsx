...
interface IMultipleResponse extends InputHTMLAttributes<HTMLInputElement> {
  id: string;
  order: number;
  title: string;
  options: string[];
...
const MultipleResponse = forwardRef(
  (
    { id, order, title, options, iserror, ...rest }: IMultipleResponse,
